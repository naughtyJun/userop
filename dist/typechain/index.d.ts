...
export type { TestAccountFactory } from "./TestAccountFactory";
...
export { TestAccount__factory } from "./factories/TestAccount__factory";
export { TestAccountFactory__factory } from "./factories/TestAccountFactory__factory";
