...
export interface SparkAccountMultiFactoryInterface extends utils.Interface {
    functions: {
...
export interface SparkAccountMultiFactory extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: SparkAccountMultiFactoryInterface;
