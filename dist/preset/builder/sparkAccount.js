...
class SparkAccount extends builder_1.UserOperationBuilder {
    constructor(signer, customerNo, rpcUrl, opts) {
        ...
        this.factory = typechain_1.SparkAccountFactory__factory.connect((opts === null || opts === void 0 ? void 0 : opts.factory) || "", this.provider);
        this.initCode = "0x";
    ...
    static init(signer, customerNo, rpcUrl, opts) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                if (!addr)
                    throw error;
                instance.proxy = typechain_1.SparkAccount__factory.connect(addr, instance.provider);
            }
            const base = instance
                .useDefaults({
