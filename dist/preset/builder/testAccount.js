...
class TestAccount extends builder_1.UserOperationBuilder {
    constructor(signer, customerNo, rpcUrl, opts) {
        ...
        this.factory = typechain_1.TestAccountFactory__factory.connect((opts === null || opts === void 0 ? void 0 : opts.factory) || "", this.provider);
        this.initCode = "0x";
        this.proxy = typechain_1.TestAccount__factory.connect(ethers_1.ethers.constants.AddressZero, this.provider);
    }
    static init(signer, customerNo, rpcUrl, opts) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                if (!addr)
                    throw error;
                instance.proxy = typechain_1.TestAccount__factory.connect(addr, instance.provider);
            }
            const base = instance
                .useDefaults({
