...
export interface SparkAccountFactoryInterface extends utils.Interface {
  ...
  encodeFunctionData(
    functionFragment: "entryPointImplementation",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export type SparkAccountInitializedEventFilter =
  TypedEventFilter<SparkAccountInitializedEvent>;
...
export interface SparkAccountFactory extends BaseContract {
  ...
  filters: {
    ...
    "SparkAccountInitialized(address,address)"(
      entryPoint?: string | null,
      account?: string | null
    ): SparkAccountInitializedEventFilter;
    SparkAccountInitialized(
      entryPoint?: string | null,
      account?: string | null
    ): SparkAccountInitializedEventFilter;
  };
