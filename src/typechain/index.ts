...
export type { SparkAccount } from "./SparkAccount";
export type { SparkAccountFactory } from "./SparkAccountFactory";
export type { SparkAccountMulti } from "./SparkAccountMulti";
export type { SparkAccountMultiFactory } from "./SparkAccountMultiFactory";
...
export { SparkAccount__factory } from "./factories/SparkAccount__factory";
export { SparkAccountFactory__factory } from "./factories/SparkAccountFactory__factory";
export { SparkAccountMulti__factory } from "./factories/SparkAccountMulti__factory";
export { SparkAccountMultiFactory__factory } from "./factories/SparkAccountMultiFactory__factory";
